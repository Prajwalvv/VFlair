...
//    }()
  ...
  lazy var nextButton: UIButton = {
    ...
    @objc func loginPage(){
        performSegue(withIdentifier: "introToLogin", sender: nil)
    }
    @objc func nextPage(){
    ...
    override func viewDidLoad() {
        ...
        nextButtonTopAnchor = nextButton.anchor(view.safeAreaLayoutGuide.topAnchor, left: nil, bottom: nil, right: view.rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 60, heightConstant: 50)[1]
    }
